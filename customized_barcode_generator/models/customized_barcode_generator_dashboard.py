# -*- coding: utf-8 -*-
"""
Customized Barcode Generator Dashboard Model
...
class CustomizedBarcodeGeneratorDashboard(models.Model):
    """Dashboard model for customized_barcode_generator analytics"""
    _name = 'customized_barcode_generator.dashboard'
    _description = 'Customized Barcode Generator Dashboard'
    _auto = False

    name = fields.Char(string='Dashboard Name', default='Customized Barcode Generator Analytics')

# POS Numpad Show/Hide

## Overview
Show/Hide NumPad in POS, that helps to display the Numpad feature in the screen
...
2. Copy the `pos_numpad_show_hide` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "POS Numpad Show/Hide"
6. Click Install

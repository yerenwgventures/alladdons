...
## Overview
This module helps to generate images for products using DALL-E.

## Installation

### Prerequisites
**Custom Dependencies:**
- product (ensure this module is available)
- openai_odoo_base (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `openai_product_images` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Generate Product Images Using OpenAI"
6. Click Install
...
⚠️ Custom dependency: openai_odoo_base

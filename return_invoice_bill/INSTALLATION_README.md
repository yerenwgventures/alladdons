...
## Overview
For creating credit note and debit note while picking.
...
2. Copy the `return_invoice_bill` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Automated Credit/Debit Note Generation from Return Picking"
6. Click Install

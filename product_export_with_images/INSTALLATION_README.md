...
## Overview
To export product details along with the product images.
...
2. Copy the `product_export_with_images` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Export Product Images"
6. Click Install

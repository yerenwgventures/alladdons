...
## Overview
One2many Mass Delete Select/Deselect Widget
...
2. Copy the `one2many_mass_select_delete` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "One2many Mass Select Delete Widget"
6. Click Install

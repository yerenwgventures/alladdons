...
## Overview
Displays the price of the products according to the pricelists
    in Product Form.
...
2. Copy the `pricelist_price_on_product` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Pricelist Price on Product"
6. Click Install

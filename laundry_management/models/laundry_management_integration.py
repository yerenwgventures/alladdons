# -*- coding: utf-8 -*-
"""
Integration Model for laundry_management with sale.order
...
class LaundryManagementIntegration(models.Model):
    """Integration model for laundry_management"""
    _name = 'laundry_management.integration'
    _description = 'Laundry Management Integration'
    ...
    target_model = fields.Char(string='Target Model', default='sale.order')

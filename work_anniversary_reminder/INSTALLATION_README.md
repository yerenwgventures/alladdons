...
## Overview
Send work anniversary emails to employees.
...
2. Copy the `work_anniversary_reminder` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Work Anniversary Reminder"
6. Click Install

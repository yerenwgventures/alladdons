...
## Overview
Sequence number for CRM opportunities
...
2. Copy the `sequence_opportunity_crm` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Unique Sequence Number In CRM Opportunity"
6. Click Install

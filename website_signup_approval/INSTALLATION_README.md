...
## Overview
Approve signup request to login to the website
...
2. Copy the `website_signup_approval` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website Signup Approval"
6. Click Install

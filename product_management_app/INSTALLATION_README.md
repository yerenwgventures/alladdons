...
## Overview
Dashboard which displays top sales, purchases monthly
...
2. Copy the `product_management_app` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Management"
6. Click Install

...
## Overview
This module is used to import the product and product 
     variants.
...
2. Copy the `product_variant_import` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Import Product variant"
6. Click Install

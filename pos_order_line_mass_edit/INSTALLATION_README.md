...
## Overview
Users have the ability to edit POS order lines
...
2. Copy the `pos_order_line_mass_edit` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "POS Order Line Mass Edit"
6. Click Install

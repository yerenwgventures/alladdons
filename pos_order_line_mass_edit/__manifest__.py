...
################################################################################
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'pos_order_line_mass_edit/static/src/app/utils/mass_edit_popup/mass_edit_popup.js',
            'pos_order_line_mass_edit/static/src/app/utils/mass_edit_popup/mass_edit_popup.xml',
        ],
    },

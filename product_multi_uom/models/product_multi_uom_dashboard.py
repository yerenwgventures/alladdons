# -*- coding: utf-8 -*-
"""
Product Multi Uom Dashboard Model
...
class ProductMultiUomDashboard(models.Model):
    """Dashboard model for product_multi_uom analytics"""
    _name = 'product_multi_uom.dashboard'
    _description = 'Product Multi Uom Dashboard'
    _auto = False

    name = fields.Char(string='Dashboard Name', default='Product Multi Uom Analytics')

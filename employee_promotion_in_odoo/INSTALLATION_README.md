...
## Overview
 This module helps to manage the proper employee promotion process.
...
2. Copy the `employee_promotion_in_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Employee Promotion"
6. Click Install

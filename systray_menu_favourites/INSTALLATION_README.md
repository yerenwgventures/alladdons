...
## Overview
This module creates a menu to show favorites menus given
...
2. Copy the `systray_menu_favourites` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Systray Menu Favourites"
6. Click Install

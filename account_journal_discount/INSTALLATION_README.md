...
## Overview
Create discount journal items for discounts in invoices and 
    bills
...
2. Copy the `account_journal_discount` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Journal Discount on Invoices And Bills"
6. Click Install

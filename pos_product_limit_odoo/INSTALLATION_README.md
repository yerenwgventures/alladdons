...
## Overview
Pos Product Limit Odoo which is used to limit the number of 
     products in the pos.
...
2. Copy the `pos_product_limit_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Pos Product Limit Odoo"
6. Click Install

...
## Overview
This module allows to capture the users image from the
    webcam.
...
2. Copy the `image_capture_upload_widget` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Image Capture Widget"
6. Click Install

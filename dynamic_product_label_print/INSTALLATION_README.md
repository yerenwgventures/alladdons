...
## Overview
Print Label Dynamically for multiple products
...
2. Copy the `dynamic_product_label_print` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Dynamic Product Label Print"
6. Click Install

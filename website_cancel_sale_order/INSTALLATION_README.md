...
## Overview
 This app allows you to cancel the sale order by specifying  the reason from website.
...
2. Copy the `website_cancel_sale_order` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website Cancel Order"
6. Click Install

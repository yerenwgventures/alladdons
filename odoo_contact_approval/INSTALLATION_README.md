...
## Overview
This module helps you manage contacts through the Approval 
    manager's validation process.
...
2. Copy the `odoo_contact_approval` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Odoo Contact Approval"
6. Click Install

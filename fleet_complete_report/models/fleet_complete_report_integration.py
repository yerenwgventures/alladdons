# -*- coding: utf-8 -*-
"""
Integration Model for fleet_complete_report with hr.expense
...
class FleetCompleteReportIntegration(models.Model):
    """Integration model for fleet_complete_report"""
    _name = 'fleet_complete_report.integration'
    _description = 'Fleet Complete Report Integration'
    ...
    ], string='Integration Type', default='reporting')
    
    # Integration-specific fields would be added here based on the target module
    target_model = fields.Char(string='Target Model', default='hr.expense')

...
## Overview
Setting up a system where all sale orders must be approved at
...
2. Copy the `approval_connector` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sale Approval Connector"
6. Click Install

# -*- coding: utf-8 -*-
"""
Project Task Unique Code Dashboard Model
...
class ProjectTaskUniqueCodeDashboard(models.Model):
    """Dashboard model for project_task_unique_code analytics"""
    _name = 'project_task_unique_code.dashboard'
    _description = 'Project Task Unique Code Dashboard'
    _auto = False

    name = fields.Char(string='Dashboard Name', default='Project Task Unique Code Analytics')

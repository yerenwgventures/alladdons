...
## Overview
Multiple price lists can be applied  to the same Sale Order.
...
2. Copy the `multi_pricelist` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sale Order Multiple Pricelist"
6. Click Install

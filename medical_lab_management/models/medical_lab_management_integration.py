# -*- coding: utf-8 -*-
"""
Integration Model for medical_lab_management with calendar.event
...
class MedicalLabManagementIntegration(models.Model):
    """Integration model for medical_lab_management"""
    _name = 'medical_lab_management.integration'
    _description = 'Medical Lab Management Integration'
    ...
    target_model = fields.Char(string='Target Model', default='calendar.event')

...
## Overview
Create Custom Fields As Per Your Need Without Any Coding.
...
2. Copy the `all_in_one_dynamic_custom_fields` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "All in One Dynamic Fields"
6. Click Install

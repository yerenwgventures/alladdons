...
## Overview
Scheduled Action Shortcut to run through systray
...
2. Copy the `scheduled_action_shortcut` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Scheduled Action Shortcut"
6. Click Install

...
## Overview
Multiple documents can be attached to a product with the help
    of this module.
...
2. Copy the `product_multi_document` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Multi Document"
6. Click Install

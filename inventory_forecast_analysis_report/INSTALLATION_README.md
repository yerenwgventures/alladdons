...
## Overview
Helps to find all the stock quantities
...
2. Copy the `inventory_forecast_analysis_report` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Inventory Forecast Analysis Report"
6. Click Install

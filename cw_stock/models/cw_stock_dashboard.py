...
class CwStockDashboard(models.Model):
    """Dashboard model for cw_stock analytics"""
    _name = 'cw_stock.dashboard'
    _description = 'Cw Stock Dashboard'
    _auto = False

    name = fields.Char(string='Dashboard Name', default='Cw Stock Analytics')

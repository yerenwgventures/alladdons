...
## Overview
Mini dashboard for Sales, Displays the total amount and count of Quotations and Sale Orders
...
2. Copy the `sale_mini_dashboard` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sale Mini Dashboard"
6. Click Install

...
## Overview
The POS Theme Sapphire Is A Responsive And Ultimate Theme For Your Odoo V18.This Theme Will Give You A New Experience With Odoo.
...
2. Copy the `pos_theme_sapphire` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "POS Theme Sapphire"
6. Click Install

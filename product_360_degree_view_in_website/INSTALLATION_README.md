...
## Overview
To see the product from all angles in eCommerce.
...
2. Copy the `product_360_degree_view_in_website` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product 360 Degree View in Website"
6. Click Install

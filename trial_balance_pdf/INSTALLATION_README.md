...
## Overview
This module helps to generate the trial balance report in PDF
    format.
...
2. Copy the `trial_balance_pdf` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Trial Balance PDF Report"
6. Click Install

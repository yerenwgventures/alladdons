...
## Overview
Enhance product details page with prominent attribute options,
...
2. Copy the `website_multi_variant` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website Multi Variant Add to Cart"
6. Click Install

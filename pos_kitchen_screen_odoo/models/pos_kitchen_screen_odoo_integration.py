# -*- coding: utf-8 -*-
"""
Integration Model for pos_kitchen_screen_odoo with mrp.bom
...
class PosKitchenScreenOdooIntegration(models.Model):
    """Integration model for pos_kitchen_screen_odoo"""
    _name = 'pos_kitchen_screen_odoo.integration'
    _description = 'Pos Kitchen Screen Odoo Integration'
    ...
    target_model = fields.Char(string='Target Model', default='mrp.bom')

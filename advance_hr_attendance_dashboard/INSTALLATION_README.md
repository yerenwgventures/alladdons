...
## Overview
This module helps you to view leaves of employee based on
...
**Custom Dependencies:**
- hr_holidays (ensure this module is available)
- hr_attendance (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `advance_hr_attendance_dashboard` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Advance HR Attendance Dashboard"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: hr_holidays

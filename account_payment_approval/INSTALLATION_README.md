...
## Overview
 This modules Enables to use the approval feature in
...
2. Copy the `account_payment_approval` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Payment Approvals"
6. Click Install

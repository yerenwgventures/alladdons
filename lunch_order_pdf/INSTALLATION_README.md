...
## Overview
Custom report for Lunch module

## Installation

### Prerequisites
**Custom Dependencies:**
- stub_lunch (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `lunch_order_pdf` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Lunch Orders - PDF"
6. Click Install
...
### Potential Conflicts
⚠️ Requires custom stub: stub_lunch

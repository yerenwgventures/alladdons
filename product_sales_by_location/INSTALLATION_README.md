...
## Overview
 We can set the location of products for delivery. 
...
- portal (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `product_sales_by_location` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Sales By Location"
6. Click Install

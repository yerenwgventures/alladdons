...
## Overview
Advanced Search in Systray enables Users to search the recordsbased on name in any Module.
...
2. Copy the `master_search_systray` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Advanced Search In Systray"
6. Click Install

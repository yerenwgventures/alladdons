...
## Overview
Hue Backend Theme is an attractive theme for Odoo backend
...
2. Copy the `hue_backend_theme` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Hue Backend Theme"
6. Click Install

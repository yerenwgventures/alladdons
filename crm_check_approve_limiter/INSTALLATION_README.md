...
## Overview
Manage CRM based on CheckList and Team/Stage andApproval Process to Make Sure Everything Completed In Each Stage
...
2. Copy the `crm_check_approve_limiter` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "CheckList & Approval Process in CRM"
6. Click Install

...
## Overview
Sale Order Discount Approval based on the Allowed discount values
...
2. Copy the `sale_order_discount_approval_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sale Order Discount Approval"
6. Click Install

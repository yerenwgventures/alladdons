...
**Custom Dependencies:**
- project_sms (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `project_task_risk_management_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Project Task Risk Management Odoo"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: project_sms

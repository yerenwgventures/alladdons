...
## Overview
Feature to Restrict Pricelist for users.
...
2. Copy the `restrict_pricelist_user` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Restrict Pricelists for Users"
6. Click Install

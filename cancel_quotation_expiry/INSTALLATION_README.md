...
## Overview
 This Module Helps to Cancel the Expired Quotations.
...
2. Copy the `cancel_quotation_expiry` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Cancel Expired Quotations"
6. Click Install

...
## Overview
Setting an reminder email to employees for their activity 
...
2. Copy the `activity_reminder` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Activity Reminder"
6. Click Install

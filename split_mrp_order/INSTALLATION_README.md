...
## Overview
Manufacturing Orders Splitting by different methods
...
2. Copy the `split_mrp_order` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Manufacturing Orders Splitting"
6. Click Install

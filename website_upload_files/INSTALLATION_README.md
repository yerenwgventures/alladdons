...
## Overview
Can upload files in payment page of website.
...
2. Copy the `website_upload_files` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Multiple Attachments In eCommerce Order"
6. Click Install

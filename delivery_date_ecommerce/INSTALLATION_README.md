...
## Overview
Expected delivery date will be displayed on the eCommerce
    website.
...
2. Copy the `delivery_date_ecommerce` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Delivery Date on eCommerce"
6. Click Install

...
## Overview
Send reminder mail for all the partners with due on sale
    order and invoicing.
...
2. Copy the `sale_invoice_due_date_reminder` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Due Date Reminder for Invoicing and Sales"
6. Click Install

...
## Overview
Education fee is the core module of Educational ERP software, 
...
2. Copy the `education_fee` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Educational Fee Management"
6. Click Install

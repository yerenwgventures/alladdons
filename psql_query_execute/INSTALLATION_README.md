...
## Overview
Odoo18 PSQL Query Execute, Run the PSQL query in the Odoo user interface.
...
2. Copy the `psql_query_execute` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "PSQL Query Execute"
6. Click Install

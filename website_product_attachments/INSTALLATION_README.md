...
## Overview
Allows Customer to Download Documents'
    'That Are Attached to the Products
...
2. Copy the `website_product_attachments` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Attachments on Website"
6. Click Install

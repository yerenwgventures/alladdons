# -*- coding: utf-8 -*-
"""
Integration Model for franchise_management with account.move
...
class FranchiseManagementIntegration(models.Model):
    """Integration model for franchise_management"""
    _name = 'franchise_management.integration'
    _description = 'Franchise Management Integration'
    ...
    target_model = fields.Char(string='Target Model', default='account.move')

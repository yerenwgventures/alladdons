...
## Overview
This app allows you to create water supplying methods
...
2. Copy the `water_supply_with_mo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Water Supply With Manufacturing Order"
6. Click Install

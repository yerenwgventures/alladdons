# -*- coding: utf-8 -*-
"""
Integration Model for manufacturing_timesheet with account.analytic.line
...
class ManufacturingTimesheetIntegration(models.Model):
    """Integration model for manufacturing_timesheet"""
    _name = 'manufacturing_timesheet.integration'
    _description = 'Manufacturing Timesheet Integration'
    ...
    target_model = fields.Char(string='Target Model', default='account.analytic.line')

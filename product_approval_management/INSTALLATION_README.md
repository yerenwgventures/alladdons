...
## Overview
Product approval allow you to control the product creation
...
2. Copy the `product_approval_management` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Approval"
6. Click Install

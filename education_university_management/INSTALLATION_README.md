...
## Overview
This modules helps to manage the university 
     education system
...
**Custom Dependencies:**
- hr_recruitment (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `education_university_management` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for " University Education Management"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: hr_recruitment

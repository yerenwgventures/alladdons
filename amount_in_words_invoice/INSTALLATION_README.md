...
## Overview
Showing the subtotal amounts of invoice, sale order 
...
2. Copy the `amount_in_words_invoice` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Amount In Words In Invoice, Sale Order And Purchase Order"
6. Click Install

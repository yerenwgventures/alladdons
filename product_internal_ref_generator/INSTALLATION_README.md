...
## Overview
Generate Internal References for the Products.
...
2. Copy the `product_internal_ref_generator` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Internal Reference Generator"
6. Click Install

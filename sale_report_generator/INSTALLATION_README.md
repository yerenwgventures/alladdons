...
## Overview
This module Helps to Generate All in One Dynamic 
    Sale Report
...
2. Copy the `sale_report_generator` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sales All In One Report Generator"
6. Click Install

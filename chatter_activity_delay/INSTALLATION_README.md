...
## Overview
Display the details of the done scheduled activities in the
    chatter.
...
2. Copy the `chatter_activity_delay` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Chatter Activity Delay"
6. Click Install

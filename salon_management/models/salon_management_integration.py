# -*- coding: utf-8 -*-
"""
Integration Model for salon_management with pos.order
...
class SalonManagementIntegration(models.Model):
    """Integration model for salon_management"""
    _name = 'salon_management.integration'
    _description = 'Salon Management Integration'
    ...
    target_model = fields.Char(string='Target Model', default='pos.order')

...
## Overview
 Perform multiple report operations in Sales/Purchase
...
2. Copy the `pdf_report_action` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Dynamic Report Operations"
6. Click Install

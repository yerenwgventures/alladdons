...
## Overview
Nutrition and allergen information of products
...
2. Copy the `product_nutrition_allergen` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Nutrition"
6. Click Install

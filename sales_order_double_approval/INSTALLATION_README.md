...
## Overview
This module helps to set two separate approvals process for a
...
2. Copy the `sales_order_double_approval` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sales Order Double Approval"
6. Click Install

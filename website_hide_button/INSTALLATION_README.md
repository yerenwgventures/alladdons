...
## Overview
Hide Price, Add To Cart and Quantity button for guest
     users
...
2. Copy the `website_hide_button` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Hide Price, Add To Cart And Quantity Button In Website"
6. Click Install

...
## Overview
This module designed to provide users with the ability to manually link invoices to specific sales orders
...
2. Copy the `order_invoice_manual_link` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sale Order Invoice Linker"
6. Click Install

...
## Overview
Scan Barcode from Camera in sale and purchase orders.
...
2. Copy the `barcode_capturing_sale_purchase` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Scan Product Barcode for Sale & Purchase"
6. Click Install

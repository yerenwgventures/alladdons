...
## Overview
Pin Records In Tree/List View module is used to Pin Records 
     in Top of the Table.
...
2. Copy the `list_tree_pin_records` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Pin Records In Tree/List View"
6. Click Install

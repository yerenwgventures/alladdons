...
## Overview
Enable product reservation functionality on your website
...
2. Copy the `website_product_reservation` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website Product Reservation"
6. Click Install

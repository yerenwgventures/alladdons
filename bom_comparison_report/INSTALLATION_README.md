...
## Overview
Comparison Report Of Bom Based on Analysis Method
...
2. Copy the `bom_comparison_report` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "BOM Comparison Report"
6. Click Install

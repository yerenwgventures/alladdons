...
### Prerequisites
**Custom Dependencies:**
- purchase_stock (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `purchase_order_delivery_status` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Delivery Status on Purchase Order"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: purchase_stock

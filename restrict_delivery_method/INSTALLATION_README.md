...
- stub_delivery (ensure this module is available)
- stub_website_sale (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `restrict_delivery_method` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Restrict Delivery Method"
6. Click Install
...
⚠️ Requires custom stub: stub_delivery

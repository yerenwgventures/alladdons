...
## Overview
The Total Cost of BOM Based on the Raw Materials Cost 
     Price. 
...
2. Copy the `bom_total_cost` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Show Total Cost on BOM"
6. Click Install

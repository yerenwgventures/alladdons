...
## Overview
Import User details with Access rights by Excel
...
2. Copy the `import_user_excel` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Import User with Access rights"
6. Click Install

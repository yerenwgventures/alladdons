...
## Overview
This module helps us to verify and delete the database name.
...
2. Copy the `verify_and_delete_database` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Verify And Delete Database"
6. Click Install

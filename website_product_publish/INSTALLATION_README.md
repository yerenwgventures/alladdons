...
## Overview
Quick Product Publish & Un publish on
     Website Shop
...
2. Copy the `website_product_publish` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Quick Product Publish/Unpublish"
6. Click Install

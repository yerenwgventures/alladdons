...
## Overview
Set warehouses per sale order lines.
...
2. Copy the `sale_order_line_multi_warehouse` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Multiple Warehouses in Sale Order Lines"
6. Click Install

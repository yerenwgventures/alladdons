...
## Overview
User can login pos session by face recognition method

## Installation

### Prerequisites
**Custom Dependencies:**
- pos_hr (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `pos_face_recognition` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Pos Face Recognition"
6. Click Install

...
## Overview
Automatic image capture while login with wrong password and a
...
2. Copy the `detect_unauthorized_login` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Unauthorized Login Notification And Image Capture"
6. Click Install

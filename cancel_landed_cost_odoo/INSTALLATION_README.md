...
**Custom Dependencies:**
- stock_landed_costs (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `cancel_landed_cost_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Cancel Landed Cost"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: stock_landed_costs

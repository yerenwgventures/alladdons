...
## Overview
Restrict POS Refund with Password In Odoo 18
...
2. Copy the `pos_refund_password` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Restrict POS Refund with Password"
6. Click Install

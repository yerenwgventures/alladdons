# -*- coding: utf-8 -*-
"""
Integration Model for cleaning_management with maintenance.equipment
...
class CleaningManagementIntegration(models.Model):
    """Integration model for cleaning_management"""
    _name = 'cleaning_management.integration'
    _description = 'Cleaning Management Integration'
    ...
    target_model = fields.Char(string='Target Model', default='maintenance.equipment')

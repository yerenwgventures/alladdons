...
## Overview
 Store and access documents for the related contact
...
2. Copy the `contact_documents` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Partner Related Documents"
6. Click Install

...
## Overview
"Verify the user before proceeding to product checkout.
...
2. Copy the `login_to_checkout` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Verify Before Checkout"
6. Click Install

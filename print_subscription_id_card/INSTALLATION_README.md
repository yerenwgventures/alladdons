...
## Overview
Print subscription ID card for user in sale order
...
2. Copy the `print_subscription_id_card` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Subscription ID Card"
6. Click Install

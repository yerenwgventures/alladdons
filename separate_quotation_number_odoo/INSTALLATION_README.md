...
## Overview
This module is used to add seperate sequence number for sales quotation and sale orders.
...
2. Copy the `separate_quotation_number_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Separate Quotation Number"
6. Click Install

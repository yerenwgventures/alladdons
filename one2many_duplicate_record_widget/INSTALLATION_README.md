...
## Overview
This widget is used for duplicating one2many records.
...
2. Copy the `one2many_duplicate_record_widget` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "One2Many Duplicate Records Widget"
6. Click Install

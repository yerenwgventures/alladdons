...
## Overview
Manage Product brand in eCommerce

## Installation

### Prerequisites
**Custom Dependencies:**
- product_brand_sale (ensure this module is available)
- stub_website_sale (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `product_brand_ecommerce` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Brand In Ecommerce"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: product_brand_sale

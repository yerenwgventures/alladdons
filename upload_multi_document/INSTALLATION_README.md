...
## Overview
This module enables users to upload and organize multipledocuments directly from the tree view.
...
2. Copy the `upload_multi_document` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Upload Multiple Attachments From Tree View"
6. Click Install

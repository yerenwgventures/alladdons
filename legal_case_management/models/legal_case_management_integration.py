# -*- coding: utf-8 -*-
"""
Integration Model for legal_case_management with project.task
...
class LegalCaseManagementIntegration(models.Model):
    """Integration model for legal_case_management"""
    _name = 'legal_case_management.integration'
    _description = 'Legal Case Management Integration'
    ...
    target_model = fields.Char(string='Target Model', default='project.task')

...
## Overview
Import/add lots while validating a purchase order picking.
...
2. Copy the `import_lots` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Import Lot from Excel"
6. Click Install

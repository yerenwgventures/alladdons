...
## Overview
Module to show the count, quantity of items in the pos screen and pos receipt
...
2. Copy the `pos_orderline_items_count` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Pos Order Line Items Count"
6. Click Install

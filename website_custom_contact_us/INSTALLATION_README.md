...
## Overview
Set The Visibility For Company Details In The Website Contact Us Page
...
2. Copy the `website_custom_contact_us` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website Custom Contact Us"
6. Click Install

# -*- coding: utf-8 -*-
"""
Integration Model for hotel_management_odoo with website.booking
...
class HotelManagementOdooIntegration(models.Model):
    """Integration model for hotel_management_odoo"""
    _name = 'hotel_management_odoo.integration'
    _description = 'Hotel Management Odoo Integration'
    ...
    target_model = fields.Char(string='Target Model', default='website.booking')

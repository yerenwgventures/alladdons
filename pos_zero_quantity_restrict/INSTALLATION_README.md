...
## Overview
This module will restrict zero quantity confirmation in POS.
...
2. Copy the `pos_zero_quantity_restrict` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "POS Restriction For Zero Quantity."
6. Click Install

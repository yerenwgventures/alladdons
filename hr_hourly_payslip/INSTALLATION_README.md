...
## Overview
Create salary based on worked hours for the employee.
...
- hr_hourly_cost (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `hr_hourly_payslip` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Hr Hourly Payslip"
6. Click Install
...
⚠️ Custom dependency: hr_hourly_cost

...
**Custom Dependencies:**
- hr_employee_updation (ensure this module is available)
- stub_hr_contract (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `hr_insurance` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Open HRMS Employee Insurance"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: hr_employee_updation

...
## Overview
To Show the Total Quantity and Total Items Ordered in POS
...
2. Copy the `total_quantity_pos` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Total Items and Total Quantity in POS"
6. Click Install

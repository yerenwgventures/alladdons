...
## Overview
Synchronize Google Contacts (Import/Export).
...
2. Copy the `odoo_google_contact_integration` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Google Contact Connector"
6. Click Install

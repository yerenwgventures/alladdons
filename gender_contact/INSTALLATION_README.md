...
## Overview
This module will helps you to give gender details for your
     contact.
...
2. Copy the `gender_contact` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Gender In Contacts"
6. Click Install

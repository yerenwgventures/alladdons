...
## Overview
This module allows users to validate or approve contacts 
...
2. Copy the `customer_supplier_approval` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Customer/Supplier Approval"
6. Click Install

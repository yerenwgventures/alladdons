...
## Overview
Automatic Payroll Processing for Active Employees in Odoo 18
...
**Custom Dependencies:**
- stub_hr_payroll (ensure this module is available)
- stub_hr_contract (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `automatic_payroll` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Automatic Payroll"
6. Click Install
...
### Potential Conflicts
⚠️ Requires custom stub: stub_hr_payroll
⚠️ Requires custom stub: stub_hr_contract

...
## Overview
Uom Product List for listing out the products in its unit of measure
...
2. Copy the `uom_product_list` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Uom Product List"
6. Click Install

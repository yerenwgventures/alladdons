...
## Overview
This module enhances the sales management process by providing a comprehensive and detailed view of both sale orders and quotation lines within a business application.
...
2. Copy the `odoo_sale_order_line_views` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sale Order Line Views"
6. Click Install

# -*- coding: utf-8 -*-
"""
Database Performance Optimizations for odoo_dynamic_dashboard
...
class OdooDynamicDashboardPerformanceOptimization(models.AbstractModel):
    """Performance optimization model for odoo_dynamic_dashboard"""
    _name = 'odoo_dynamic_dashboard.performance.optimization'
    _description = 'Performance Optimization for Odoo Dynamic Dashboard'

    @api.model
    def init_performance_indexes(self):
        """Initialize performance indexes"""
        # Add indexes for frequently queried fields
        indexes_to_create = {'dashboard_block': ['sequence', 'active'], 'dashboard_menu': ['parent_id', 'sequence']}

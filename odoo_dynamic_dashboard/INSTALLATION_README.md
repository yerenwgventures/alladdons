# Advanced Dynamic Dashboard Odoo18

## Overview
Odoo Dynamic Dashboard, Dynamic Dashboard, Odoo AI, Odoo18, Odoo18 Dashboards, Dashboard with AI, AI Dashboard, Odoo Dashboard,Graph View,
...
2. Copy the `odoo_dynamic_dashboard` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Advanced Dynamic Dashboard Odoo18"
6. Click Install

...
## Overview
Create Manufacturing Orders, Purchase Orders and Sales Orders
    in Bulk.
...
2. Copy the `bulk_create_mo_so_po` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Bulk Order Management"
6. Click Install

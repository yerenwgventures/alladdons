...
## Overview
The Table Reservation in Pos module is used to facilitate
...
2. Copy the `table_reservation_in_pos` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Table Reservation in POS"
6. Click Install

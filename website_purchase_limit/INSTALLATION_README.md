# Minimum Purchase Limit In Website

## Overview
Its help to set minimum purchase limit to the website.
...
2. Copy the `website_purchase_limit` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Minimum Purchase Limit In Website"
6. Click Install

...
## Overview
This module helps you to create contact and addresses
     from website.
...
2. Copy the `website_customer_contact` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website Customer Contact"
6. Click Install

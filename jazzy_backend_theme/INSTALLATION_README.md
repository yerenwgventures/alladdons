...
## Overview
Jazzy backed Theme is an attractive theme for backend
...
2. Copy the `jazzy_backend_theme` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Jazzy Backend Theme"
6. Click Install

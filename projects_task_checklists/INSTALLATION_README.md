...
## Overview
Manage the Project's tasks and subtasks checklists.
...
2. Copy the `projects_task_checklists` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Project Task Checklist"
6. Click Install

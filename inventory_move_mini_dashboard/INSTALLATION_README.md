...
## Overview
Mini Dashboard View for Stock Moves and Transfers
...
2. Copy the `inventory_move_mini_dashboard` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Inventory Move Mini Dashboard"
6. Click Install

# Mass Register Expense Payment

## Overview
Register the payments of multiple expenses together.
...
2. Copy the `hr_expense_mass_payment` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Mass Register Expense Payment"
6. Click Install

...
## Overview
This module will helps to add Unit of Measure condition in the
    advanced Price list rule.
...
2. Copy the `uom_in_pricelist` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "UOM In PriceList"
6. Click Install

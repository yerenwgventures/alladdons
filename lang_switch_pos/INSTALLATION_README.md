...
## Overview
Adds a language switch button to switch language in POS
...
2. Copy the `lang_switch_pos` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "POS Language Switcher"
6. Click Install

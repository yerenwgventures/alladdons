...
## Overview
This module is designed to generate  Customer/Supplier Payment
    Statement Reports.
...
2. Copy the `statement_report` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Customer/ Supplier Payment Statement Report"
6. Click Install

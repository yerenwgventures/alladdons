...
## Overview
Proof Attachment In Website for Odoo 17 Community and 
    Enterprise Edition.
...
2. Copy the `payment_proof_attachment` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Payment Proof Attachment"
6. Click Install

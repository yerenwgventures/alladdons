...
## Overview
Theme Upshift is a modern and versatile website theme designed for businesses looking to establish a professional presence and feature
...
**Custom Dependencies:**
- web_editor (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `theme_upshift` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Theme Upshift"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: web_editor

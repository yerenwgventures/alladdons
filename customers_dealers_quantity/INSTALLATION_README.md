...
## Overview
The Dealer will get a Special Price if he Orders the Minimum
     Amount of Products
...
2. Copy the `customers_dealers_quantity` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Customer's Dealers Special Price"
6. Click Install

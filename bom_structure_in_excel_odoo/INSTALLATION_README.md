...
## Overview
Effortlessly export BOM Structure & Cost Reports to Excel
    format
...
2. Copy the `bom_structure_in_excel_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "BOM Structure & Cost Report in Excel"
6. Click Install

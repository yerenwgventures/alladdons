...
### Prerequisites
**Custom Dependencies:**
- stub_survey (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `survey_question_duplicator` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Question Duplicator In Survey"
6. Click Install
...
### Potential Conflicts
⚠️ Requires custom stub: stub_survey

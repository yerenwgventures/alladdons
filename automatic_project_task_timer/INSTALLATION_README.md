...
## Overview
Automatic Running Timer for Project Tasks
...
2. Copy the `automatic_project_task_timer` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Automatic Project Task Timer"
6. Click Install

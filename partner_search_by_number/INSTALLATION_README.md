...
## Overview
 This app allows us to search customer by their phone number
     and mobile numbers.
...
2. Copy the `partner_search_by_number` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Partner Search By Number"
6. Click Install

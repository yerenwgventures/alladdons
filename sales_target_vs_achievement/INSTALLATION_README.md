...
## Overview
Sales Target and Achievements based on Salesperson's individual target
...
2. Copy the `sales_target_vs_achievement` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Sales Target VS Achievement"
6. Click Install

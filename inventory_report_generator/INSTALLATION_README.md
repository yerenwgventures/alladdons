...
## Overview
Dynamic Inventory Report Generator for Odoo 17
...
2. Copy the `inventory_report_generator` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Inventory All In One Report Generator"
6. Click Install

...
## Overview
Advanced Leave Dashboard helps to view your and your 
...
- hr_org_chart (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `hr_leave_dashboard` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Hr Leave Dashboard"
6. Click Install
...
⚠️ Custom dependency: hr_org_chart

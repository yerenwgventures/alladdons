...
## Overview
Generates various reports from POS screen and reporting 
    menu
...
2. Copy the `advanced_pos_reports` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Advanced POS Reports"
6. Click Install

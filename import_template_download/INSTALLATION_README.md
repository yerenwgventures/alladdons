...
## Overview
Download Import Templates for Sales, Purchases and
    Invoices.
...
2. Copy the `import_template_download` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Import Template For Sales / Purchase / Invoice"
6. Click Install

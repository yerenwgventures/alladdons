...
## Overview
Theme Blast  makes the website more unique and attractive through its style and custom-designed snippet
...
2. Copy the `theme_blast` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Theme Blast"
6. Click Install

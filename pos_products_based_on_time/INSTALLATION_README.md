...
## Overview
This module enables you to display time-based products in POS.
...
2. Copy the `pos_products_based_on_time` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "PoS Happy Hours | PoS Time Based Products | PoS Breakfast Lunch Dinner"
6. Click Install

...
## Overview
Snippet for Previewing PDF Files on Website
...
2. Copy the `website_pdf_preview_snippet` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website PDF Preview Snippet"
6. Click Install

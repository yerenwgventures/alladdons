...
## Overview
Send Email Reminders To The Assigned Users For Overdue Tasks
...
2. Copy the `task_overdue_email_odoo` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Task Overdue Email Notification"
6. Click Install

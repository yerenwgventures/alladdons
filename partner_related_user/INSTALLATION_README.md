...
## Overview
This module will help you to add related user in the 
...
2. Copy the `partner_related_user` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Partner Related User and User Filters"
6. Click Install

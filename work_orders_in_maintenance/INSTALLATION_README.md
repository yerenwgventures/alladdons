...
## Overview
To Maintain the Work Orders and the Material Request.
...
**Custom Dependencies:**
- maintenance (ensure this module is available)
- mrp (ensure this module is available)

### Installation Steps
1. Ensure all prerequisites are installed
2. Copy the `work_orders_in_maintenance` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Work Orders in Maintenance"
6. Click Install
...
### Potential Conflicts
⚠️ Custom dependency: maintenance

...
## Overview
Search product images via Bing Image Downloader in the product
...
2. Copy the `product_image_suggestion` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Image Suggestion"
6. Click Install

...
## Overview
Picking Order Lines Views is helpful for the Detailed view of the picking
...
2. Copy the `odoo_picking_order_line_views` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Picking Order Line Views"
6. Click Install

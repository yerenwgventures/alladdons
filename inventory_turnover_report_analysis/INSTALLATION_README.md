...
## Overview
A module for generate inventory turnover analysis report.
...
2. Copy the `inventory_turnover_report_analysis` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Inventory Turnover Analysis Report"
6. Click Install

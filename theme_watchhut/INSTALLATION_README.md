...
## Overview
Theme WatchHut is an attractive and modern eCommerce Website theme
...
2. Copy the `theme_watchhut` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Theme WatchHut"
6. Click Install

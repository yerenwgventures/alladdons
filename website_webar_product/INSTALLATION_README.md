...
## Overview
Realistic view of the product in website.
...
2. Copy the `website_webar_product` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Website WebAR Product Viewer"
6. Click Install

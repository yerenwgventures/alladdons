...
## Overview
Users in the Group "Product Deletion" Can Only Delete 
     the Products
...
2. Copy the `product_deletion` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Removal Authorisation"
6. Click Install

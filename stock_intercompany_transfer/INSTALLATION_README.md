...
## Overview
Create counterpart Receipt/Delivery Orders between
    companies.
...
2. Copy the `stock_intercompany_transfer` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Inter Company Stock Transfer"
6. Click Install

...
## Overview
This module offers a concise, intuitive way to view price 
...
2. Copy the `dynamic_product_pricelist` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Product Dynamic Pricelist"
6. Click Install

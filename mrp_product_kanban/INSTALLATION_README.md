...
## Overview
This module is to manage manufacturing order details in
    product kanban view.
...
2. Copy the `mrp_product_kanban` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Manufacturing Product Kanban"
6. Click Install

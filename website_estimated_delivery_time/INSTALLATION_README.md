...
## Overview
This module allows you to see the delivery time on the website
    product page.
...
2. Copy the `website_estimated_delivery_time` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Estimated Delivery Time On Website"
6. Click Install

...
## Overview
Dark Mode Backend Theme for Odoo 18 community edition
...
2. Copy the `dark_mode_backend` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Dark Mode Backend Theme"
6. Click Install

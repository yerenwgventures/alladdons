...
## Overview
Provides opportunity to connect with your Monday.com account"
    from Odoo.
...
2. Copy the `monday_odoo_connector` folder to your Odoo addons directory
3. Restart Odoo server
4. Update apps list: Settings → Apps → Update Apps List
5. Search for "Monday.com Odoo Connector"
6. Click Install
